...
import aboutImg from '../assets/AboutAs.png'
import pplImg from '../assets/ppl.png'
import handsImg from '../assets/2hands.png'
        ...
        <div className='flex flex-col md:flex-row flex-wrap items-center justify-center' >
          ...
          <div className='md:w-1/2 mx-auto grid  grid-cols-1 md:grid-cols-2 gap-12'>
            <div className='  flex items-center  gap-12  '>
              <img src={pplImg} alt='oo' className='w-[60px] h-[60px] bg-[#0dc0306a] rounded-tl-2xl rounded-br-2xl mb-4 text-brandPrimary'/>
            ...
            <div className='  flex items-center  gap-12  '>
              <img src={handsImg} alt='oo' className='w-[60px] h-[60px] bg-[#0dc0306a] rounded-tl-2xl rounded-br-2xl mb-4'/>
              <div className=' flex flex-col items-center justify-center gap-1  '>
            ...
            <div className='  flex items-center  gap-12  '>
              <img src={tapImg} alt='oo' className='w-[60px] h-[60px] bg-[#0dc0306a] rounded-tl-2xl rounded-br-2xl mb-4 '/>
              <div className=' flex flex-col items-center justify-center gap-1  '>
            ...
            <div className='  flex items-center  gap-12  '>
              <img src={paymentImg} alt='oo' className='w-[60px] h-[60px] bg-[#0dc0306a] rounded-tl-2xl rounded-br-2xl mb-4 '/>
              <div className=' flex flex-col items-center justify-center gap-1  '>
